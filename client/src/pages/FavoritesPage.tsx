    ...
    <div className="grid gap-4">
      <section className="rounded-md border border-line bg-white p-4 shadow-soft">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">{favorites.length} saved channels</p>
          </div>
        </div>
      </section>
      ...
      <section className="grid gap-3 md:grid-cols-2">
        {favorites.map((channel) => (
          <article key={channel.id} className="grid grid-cols-[auto_1fr_auto] items-center gap-3 rounded-md border border-line bg-white p-3 shadow-soft">
