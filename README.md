...
- Desktop playback with FFmpeg-generated fMP4 live HLS and raw diagnostic links; mobile opens streams natively.
...
`FFMPEG_PATH` defaults to `ffmpeg`. The published Docker image includes FFmpeg for desktop live transcoding.
